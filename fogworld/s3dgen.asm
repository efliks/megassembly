...
;************************************************************
S3d_CorrectFaces proc
    mov     edi, d [esi + S3D_PTR_FACES]
    mov     ecx, d [esi + S3D_NUM_FACES]
SCF_do:
    add     w [edi + 0], ax
    add     w [edi + 2], ax
    add     w [edi + 4], ax
