; (C) November 6, 2001  M. Feliks

include stub.inc

STACK_SIZE equ 0ffffh
...
dpmi_err1    db 'DPMI host is not installed.', 10, 13, '$'
dpmi_err2    db '32-bit protected mode is unsupported.', 10, 13, '$'
dpmi_err3    db 'Can not switch to protected mode.', 10, 13, '$'
